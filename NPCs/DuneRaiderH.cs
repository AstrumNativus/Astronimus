...
{
	//[AutoloadBossHead]
	internal class DuneRaiderH : DuneRaider
	{
		...
		public override void CustomBehavior()
		{
			if (Main.netMode != NetmodeID.MultiplayerClient)
			{
				...
				if(attackCounter <= 0 && Vector2.Distance(npc.Center, target.Center) < 1000 && Collision.CanHit(npc.Center, 1, 1, target.Center, 1, 1))
				{
					...
					int projectile = Projectile.NewProjectile(npc.Center, direction * 5, ProjectileID.SandnadoHostile, 10, 5, Main.myPlayer);
	...
	internal class DuneRaiderB : DuneRaider
	{
	...
	internal class DuneRaiderT : DuneRaider
	{
	...
	public abstract class DuneRaider : SandWorm
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("The Dune Raider");
		}
		...
		public override void Init()
		{
			minLength = 30;
			maxLength = 30;
			tailType = NPCType<DuneRaiderT>();
			bodyType = NPCType<DuneRaiderB>();
			headType = NPCType<DuneRaiderH>();
			speed = 6f;
			turnSpeed = 0.25f;
		}
	}
	...
	public abstract class SandWorm : ModNPC
	{
		/* ai[0] = follower
		 * ai[1] = following
