...
{
	//[AutoloadBossHead]
	internal class FrostWyrmHead : FrostWyrm
	{
		...
		public override void SetDefaults()
		{
			...
			npc.width = 60;
			npc.height = 60;
			music = mod.GetSoundSlot(SoundType.Music, "Sounds/Music/FrostWyrm");
			npc.boss = true;
		...
		public override void CustomBehavior()
		{
			if (Main.netMode != NetmodeID.MultiplayerClient)
			{
				...
				if(attackCounter <= 0 && Vector2.Distance(npc.Center, target.Center) < 1000 && Collision.CanHit(npc.Center, 1, 1, target.Center, 1, 1))
				{
					...
					int projectile = Projectile.NewProjectile(npc.Center, direction * 10, ProjectileID.FrostWave, 20, 5, Main.myPlayer);
	...
	internal class FrostWyrmBody : FrostWyrm
	{
	...
	internal class FrostWyrmTail : FrostWyrm
	{
	...
	public abstract class FrostWyrm : Worm
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("The Frost Wyrm");
		}
		...
		public override void Init()
		{
			minLength = 14;
			maxLength = 14;
			tailType = NPCType<FrostWyrmTail>();
			bodyType = NPCType<FrostWyrmBody>();
			headType = NPCType<FrostWyrmHead>();
			speed = 8f;
			turnSpeed = 0.75f;
		}
	}
