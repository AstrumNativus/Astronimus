...
{
    public class AstralGlyph : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Astral Glyph");
        ...
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shoot = ProjectileID.LunarFlare;  //this make the item shoot your projectile
        ...
        {                                        //this is how to craft this item
            ...
            recipe.AddIngredient(ItemID.LunarFlareBook, 10);
            recipe.AddIngredient(ItemID.Meowmere, 10);
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int i = 0; i < numberProjectiles; i++)
            {
                ...
                type = Main.rand.Next(new int[] { type, ProjectileID.StarWrath, ProjectileID.LunarFlare, ProjectileID.Meowmere });
            }
            return true;
