...
{
    public class HellsCircle : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Hell's Cirlce");
        ...
        {                                        //this is how to craft this item
            ...
            recipe.AddIngredient(ItemID.DemonScythe, 10);
            recipe.AddIngredient(ItemID.UnholyTrident, 10);
