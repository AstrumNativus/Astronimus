...
{
    public class DuneFrostShortsword : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Dune Frost Shortsword");
            Tooltip.SetDefault("The Sword of the Wyrm and Raider");
        }
        public override void SetDefaults()
        {
            ...
            item.useStyle = 3;        //this is how the item is holded
            item.noMelee = true;
            item.knockBack = 5;
            item.value = 1;
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("DFSword");  //this make the item shoot your projectile
